        ...
        return (
            <div>
              <div className="mt-2 ">
                ...
                <button
                  className="bg-gray-300 ml-6 p-2 text-xs font-semibold rounded-md hover:bg-slate-500 active:bg-slate-500 focus:outine-none focus:ring focus:ring-slate-400"
                  value={"7"}
                  onClick={dayHandler}
                >
                  1W
